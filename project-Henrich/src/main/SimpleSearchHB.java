...
public class SimpleSearchHB extends HttpServlet implements Info {
   ...
   void display(List<Manga> listEmployees, PrintWriter out) {
      for (Manga employee : listEmployees) {
         System.out.println("[DBG] " + employee.getId() + ", " //
               + employee.getTitle() + ", " //
               + employee.getAuthor() + ", " //
         	   + employee.getGenre() + ", " //
         	   + "Volumes: " + employee.getVolumes() + ", " //
         	   + "Year released: " + employee.getYear());
         ...
         out.println("<li>" + employee.getId() + ", " //
               ...
               + employee.getGenre() + ", " //
               + "Volumes: " + employee.getVolumes() + ", " //
         	   + "Year released: " + employee.getYear() + "</li>");
      }
   }
